...
const forecast = (latitude, longitude, callback) => {
    ...
    request ( {url, json: true} , (error, {body} = {}) => { //using shorthand syntax fro url; names are identical
        if(error) {
            ...
            callback(undefined, body.current.weather_descriptions[0]+ ", Humidity " + body.current.humidity + "% " + ". It is currently " + body.current.temperature + " degree out, It feels like " + body.current.feelslike + " degree out.")
